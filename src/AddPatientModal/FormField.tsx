...
export const SelectEntry: React.FC<SelectEntryProps> = ({ name, label, options }) => (
  <Form.Field>
    <label>{label}</label>
...
export const SelectHealthRating: React.FC<SelectHealthRatingProps> = ({ label, name, options }) => (
  <Form.Field>
    <label>{label}</label>
    <Field as="select" name={name} className="dropdown ui">
      {options.map((option) => (
